...
class YoutubePlayerApi{
 ...
 Future<YoutubePlayerModel> getVideoSearch({required String searchVideoTitle})async{

final key = _apiKey.getYoutubeKey();
    final response = await http.get(
    Uri.parse("https://www.googleapis.com/youtube/v3/search?key=$key&q=$searchVideoTitle&type=video&part=snippet"));
